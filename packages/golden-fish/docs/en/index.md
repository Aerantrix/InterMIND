  ...
  <div class="gf-container">
    ...
    <div class="gf-grid-4">
      <div class="gf-benefit-card">
        ...
        <p class="gf-benefit-desc">Every engagement under legal contract. No agents, no outsourcing — we do everything in-house.</p>
      </div>
      <div class="gf-benefit-card">
        <div class="gf-benefit-icon"><Icon icon="tabler:users-group" /></div>
        <h3 class="gf-benefit-title">In-house licensed team</h3>
        <p class="gf-benefit-desc">Specialists in legal, financial, and visa matters. One team from inquiry to ongoing support.</p>
      </div>
      <div class="gf-benefit-card">
        <div class="gf-benefit-icon"><Icon icon="tabler:lock-check" /></div>
        <h3 class="gf-benefit-title">Transparent prepayment</h3>
        <p class="gf-benefit-desc">Fixed-price quote upfront and in writing. Work starts only after you review and approve.</p>
      </div>
      <div class="gf-benefit-card">
        <div class="gf-benefit-icon"><Icon icon="tabler:trending-up" /></div>
        <h3 class="gf-benefit-title">Proven success rate</h3>
        <p class="gf-benefit-desc">Over 90% approval rate across hundreds of UAE company registrations.</p>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="gf-cases-grid">
      <div class="gf-case-card">
        ...
        <div class="gf-case-content">
          ...
          <div class="gf-case-stats">5 employees · IFZA · 4 visas · Bank on first try</div>
          <p class="gf-svc-desc">Full team relocation in 5 weeks. Trade licence, visas, and corporate account opened in parallel.</p>
          <p class="gf-case-quote">"They handled everything I dreaded — paperwork, bank meetings, government filings. I just signed."<br><span class="gf-case-author">— Andrey, CEO &amp; Founder</span></p>
        </div>
      </div>
      <div class="gf-case-card">
      ...
      <div class="gf-case-card">
        ...
        <div class="gf-case-content">
          ...
          <p class="gf-case-quote">"From investor visa to school placements — they made our move into Dubai feel effortless."<br><span class="gf-case-author">— Anna, Switzerland</span></p>
        </div>
      </div>
    </div>
  </div>
